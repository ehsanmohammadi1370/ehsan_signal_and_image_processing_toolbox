...
% for Random Forest (RF), K-Nearest Neighbors (KNN), and Linear Discriminant Analysis (LDA) classifiers.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Date: 18.08.2023
...
% k=5;step=1;jj=1;
% [m_RF, std_RF, m_KNN, std_KNN, m_LDA, std_LDA] = kfold_function(Data, Labels, k, step, jj)

function [m_RF, std_RF, m_KNN, std_KNN, m_LDA, std_LDA] = kfold_function(Data, Labels, k, step, jj)
for i = 1:k

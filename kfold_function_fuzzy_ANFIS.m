% The kfold_function_fuzzy_ANFIS function calculates the accuracy of k-fold cross-validation 
% for the fuzzy classifier ANFIS.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Date: 19.08.2023
% Inputs:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% kfold_function_fuzzy_ANFIS Function, Coded by Ehsan
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% [ m_anfis, std_anfis ] = kfold_function_fuzzy_ANFIS(Data, Labels, method, k, step, jj)


function [ m_anfis, std_anfis ] = kfold_function_fuzzy_ANFIS( Data, Labels, method, k, jj, step )
    label1 = min(Labels);
    label2 = max(Labels);
    ...
    for i = 1:k
        ...
        % Fuzzy Classifier Testing (ANFIS)
    ...
    % Calculate Mean and Standard Deviation of ANFIS Accuracy
    m_anfis = mean(acc2);
    std_anfis = std(acc2);
end

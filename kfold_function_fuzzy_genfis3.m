% The kfold_function_fuzzy_genfis3 function calculates the accuracy of k-fold cross-validation 
% for fuzzy classifiers: genfis3.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Date: 19.08.2023
% Inputs:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% kfold_function_fuzzy_genfis3 Function, Coded by Ehsan
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% [ m_genfis3, std_genfis3 ] = kfold_function_fuzzy_genfis3(Data, Labels, method, k, step, jj)


function [ m_genfis3, std_genfis3 ] = kfold_function_fuzzy_genfis3( Data, Labels, method, k, jj, step )
    label1 = min(Labels);
    label2 = max(Labels);
